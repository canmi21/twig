/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --env-interface CloudflareEnv` (hash: 7b1211c7d19245818bceafbf4819b70f)
// Runtime types generated with workerd@1.20260312.1 2026-03-12 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		taki_sql: D1Database
		CF_ACCESS_TEAM_DOMAIN: 'https://canmi.cloudflareaccess.com'
		CF_ACCESS_AUD: 'TODO_PASTE_AUD_TAG_FROM_CF_DASHBOARD'
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<Cloudflare.Env, 'CF_ACCESS_TEAM_DOMAIN' | 'CF_ACCESS_AUD'>
	> {}
}
