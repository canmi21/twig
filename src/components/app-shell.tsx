  ...
  return (
    <main className="relative mx-auto min-h-screen w-full max-w-7xl px-5 py-8 sm:px-8 sm:py-12 lg:px-12">
      ...
      <div className="relative">
        <header className="mb-10 flex flex-col gap-4 rounded-[2rem] border border-border/60 bg-white/75 px-5 py-4 shadow-[0_14px_45px_rgba(15,23,42,0.06)] backdrop-blur sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="text-xs font-medium uppercase tracking-[0.26em] text-muted-foreground">
              ~/ full-stack workspace
            </div>
            <div className="mt-2 font-serif text-3xl italic text-foreground">
              taki
            </div>
          </div>
