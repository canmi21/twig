 ...
 * the first registered user are bootstrapped as admins. In dev, use
 * the /__dev identity switcher to sign in without going through the
 * real OTP flow; prod requires a real cookie session.
 */
