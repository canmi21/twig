...
const FONT_PATH =
  '/css2?family=Noto+Sans+SC:wght@100..900&family=Roboto:ital,wght@0,100..900;1,100..900&family=Source+Sans+3:ital,wght@0,200..900;1,200..900&display=swap'
...
(function(){
  ...
  function check(){
    document.fonts.ready.then(function(){
      if(document.fonts.check("16px 'Source Sans 3'")&&document.fonts.check("16px 'Roboto'"))return;
